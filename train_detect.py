...
# -*- coding: utf-8 -*-
"""
The keras implementation of character-digit recognition.
"""
...
test_set = test_datagen.flow_from_directory('Test_car_images_dataset',target_size=(64, 64),batch_size=32,class_mode='categorical')
